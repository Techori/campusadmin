      ...
      <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <CardContent className="flex flex-col items-center space-y-4">
              ...
              {!isEditing ? (
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500">{profileData.designation}</p>
                </div>
              ) : (
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" onClick={handleChangePicture}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      disabled={!isEditing}
                      className={`pl-10 ${!isEditing ? 'bg-gray-50' : 'bg-white border-gray-300 focus:border-blue-500'}`}
                    />
                  </div>
                </div>
                <div className="space-y-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>System and account related details</CardDescription>
          </CardHeader>
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              ...
              <p className="font-semibold text-purple-700">{profileData.department}</p>
            </div>
          </CardContent>
        </Card>
      </div>
