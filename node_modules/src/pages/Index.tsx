            ...
            <div className="animate-fade-in">
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6 mb-8 border border-gray-100">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Button onClick={handleGetStarted} className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 py-3 text-lg font-semibold hover:shadow-lg transition-all duration-200">
                    Search Jobs
      ...
      <section id="jobs" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            ...
            <Button variant="outline" onClick={handleGetStarted} className="hover:shadow-lg transition-all duration-200">
              View All Jobs
      ...
      <section id="companies" className="py-20 bg-gradient-to-br from-gray-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            ...
            <Button onClick={handleHireTalent} variant="outline" className="hover:shadow-lg transition-all duration-200">
              Join Our Network
              <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
          </div>
